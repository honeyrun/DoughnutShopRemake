<template>
  <nav :class="{ onScroll: !view.topOfPage }">
    ...
    <div class="page">
      <ul>
        <li><router-link to="/" @click="toTop">Home</router-link></li>
        <li>
          <router-link to="/productlist" @click="toTop">Menu</router-link>
        </li>
        <li><router-link to="/about" @click="toTop">About Us</router-link></li>
      </ul>
    </div>
    <div>
      <ul>
